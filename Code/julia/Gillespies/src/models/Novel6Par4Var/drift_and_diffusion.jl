function Novel6Par4VarAB(P :: NovelStruct; symbolic = true)
    @variables x::Real y::Real n::Real b::Real
    ...
    r₁ = ReactionStruct( t⁺ = k₁ * n * x, t⁻ = k₋₁ * x * x,
                                          r = [ 1; 0;-1; 0])
    r₂ = ReactionStruct( t⁺ = k₂ * n * x, r = [ 0; 1;-1; 0])
    r₃ = ReactionStruct( t⁺ = k₃ * b * x, r = [-1; 0; 1; 0])
    r₄ = ReactionStruct( t⁺ = k₄ * b * y, r = [ 0;-1; 1;-1])
    r₅ = ReactionStruct( t⁺ = k₅ * y,     r = [ 0;-1; 1; 0])
    r₆ = ReactionStruct( t⁺ = k₆,         r = [ 0; 0; 0; 1])
